...
public class RouteOptimizationGUI extends JFrame{
        ...
        private void initializeCitiesAndDistances() {
            ...
            cityPositions.put("Dharan", new Point(400, 150));
            cityPositions.put("Itahari", new Point(300, 400));
            cityPositions.put("Jhapa", new Point(500, 300));
            cityPositions.put("Ilam", new Point(600, 200));


            String[] cities = {"Kathmandu", "Pokhara", "Dharan", "Itahari", "Jhapa", "Ilam"};
            ...
            addConnection("Pokhara", "Itahari", 50);
            addConnection("Itahari", "Ilam", 150);
            addConnection("Ilam", "Jhapa", 50);
            addConnection("Dharan", "Ilam", 55);
            addConnection("Dharan", "Pokhara", 200);
        }
