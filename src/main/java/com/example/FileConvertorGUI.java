...
public class FileConvertorGUI extends JFrame {
    ...
    private void startConversion() {
        ...
        currentWorker = new SwingWorker<>() {
            ...
            protected void done() {
                ...
                cancelButton.setEnabled(false);
                if (!isCancelled()) {
                    JOptionPane.showMessageDialog(FileConvertorGUI.this, "Conversion completed!", "Info", JOptionPane.INFORMATION_MESSAGE);
                } else {
                    JOptionPane.showMessageDialog(FileConvertorGUI.this, "Conversion cancelled!", "Info", JOptionPane.INFORMATION_MESSAGE);
                }
            }
        };
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(() -> {
            FileConvertorGUI converterGUI = new FileConvertorGUI();
